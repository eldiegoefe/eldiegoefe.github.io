...
El ejemplo del capítulo [Functional
Programming](http://www.braveclojure.com/functional-programming/#4__Peg_Thing_)
(del libro [Clojure for the Brave and True](http://www.braveclojure.com/) me
hizo analizar con detenimiento muchas funciones para poder entender un poco su
funcionamiento. Esta es una serie de anotaciones para recordar mi temblorosa
exploración.
...
2.  [assoc-in](http://clojuredocs.org/clojure.core/assoc-in): arma o
    agrega valores a un mapa anidado. Puede usarse de distintas maneras
    para modificar o agregar elementos de un mapa o vector con mapas.
